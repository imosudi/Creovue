...
import random
from app.utils.youtube_client import get_youtube_client
from app.utils.decorators import cached, handle_api_error
...
from app.config import creo_api_key, creo_base_url
# models/trends.py
