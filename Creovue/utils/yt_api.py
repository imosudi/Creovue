...
def calculate_ctr_metrics(channel_id, days=700):
    ...
    Returns:
        dict: Dictionary containing CTR metrics, impressions, and retention data
    """
    try:
        ...
        try:
            ...
            if 'accessNotConfigured' in str(e):
                raise Exception("YouTube Analytics API not enabled. Please enable it in Google Cloud Console.")
            raise
            
        # Rest of your function implementation...
        # [Keep all your existing code for fetching data]
        
    except Exception as e:
        print(f"Error in calculate_ctr_metrics: {str(e)}")
        return {
            "error": str(e),
            "overall_metrics": {
                "total_impressions": 0,
            ...
            "best_performers": {
                "best_ctr_video": None,
                "best_retention_video": None,
                "most_impressions_video": None
            },
            "all_videos": []
        }
